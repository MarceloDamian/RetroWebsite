...
import { SuppressionCreationData, SuppressionCreationResult, SuppressionDataType, SuppressionDestroyResult, SuppressionList, SuppressionListQuery, SuppressionListResponse, SuppressionModels } from 'mailgun.js/interfaces/Suppressions/Suppressions';
import { IBounce, BounceData } from 'mailgun.js/interfaces/Suppressions/Bounce';
import { IComplaint, ComplaintData } from 'mailgun.js/interfaces/Suppressions/Complaint';
import { IUnsubscribe, UnsubscribeData } from 'mailgun.js/interfaces/Suppressions/Unsubscribe';
import { IWhiteList, WhiteListData } from 'mailgun.js/interfaces/Suppressions/WhiteList';
import NavigationThruPages from 'mailgun.js/common/NavigationThruPages';
